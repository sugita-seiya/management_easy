...
- 勤怠管理システム</br>
  当月分の勤怠を管理出来るアプリ。
  <使い方>
  1.出社後、出勤ボタンを押下(押下時にSlackに出勤連絡が通知される)
  2.退社時に退勤ボタンを押下(ボタンを押し忘れた時は次の日に自動で押下してくれる)
  3.遅刻 or その他の連絡事項があれば連絡(Slackに連絡内容が連携される)
  4.月末に管理者へ勤怠を送信
  5.送信された勤怠を承認 or 再提出を選択する(管理者用)
- 作成目的</br>
　理由
- アプリ URL</br>
  http://18.180.240.234
